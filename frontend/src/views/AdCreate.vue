    ...
    <div class="ad-create-content">
      ...
      <a-card class="progress-card surface-card" :bordered="false">
        <div class="progress-heading">
          <div>
            <div class="progress-title">{{ $t('adCreate.progress.headerTitle') }}</div>
            <div class="progress-subtitle">
              {{ $t('adCreate.progress.stepOf', { step: currentStep, total: 3 }) }}
            </div>
          </div>
          <span class="progress-tag">{{ currentStep }} / 3</span>
        </div>
...
.progress-card :deep(.ant-steps-item-title) {
  font-weight: 600;
  color: #0f172a;
}

.progress-card :deep(.ant-steps-item-description) {
  color: #64748b;
}

.progress-card :deep(.ant-steps-item-tail::after) {
